...
- 현재 앱 상태는 단일 목표·계획 모델입니다. 계획은 유저가 직접 만들기 때문에 생성 횟수 제한이 없으며, Pro 다중 목표·활성 계획 UX는 아직 별도 구현이 필요합니다.
...
24시간 무료 체험은 별도 요금제가 아니라 Free 회원이 계정당 한 번 Pro 기능을 이용하는 상태입니다. 체험 중에는 AI 크레딧 15개를 제공하고 일일 한도는 30개이며, 종료 시 남은 체험 크레딧은 소멸합니다.
