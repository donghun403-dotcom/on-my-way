...
Toss Payments 자동결제는 부분 구현 상태이며 운영 결제는 비활성화되어 있습니다. 목표 상품 가격은 월 3,900원이지만 `PAYMENTS_ENABLED=false`가 유지되는 동안 실제 결제가 가능한 것으로 표시하지 않습니다. 추가 AI 크레딧 팩은 이 버전에서 판매하지 않습니다.
